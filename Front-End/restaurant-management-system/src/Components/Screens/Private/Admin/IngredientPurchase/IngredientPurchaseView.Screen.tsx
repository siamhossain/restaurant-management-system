...
import {IIngredientPurchaseParticular} from "@/App/Interfaces/Models";

interface IIngredientPurchaseViewScreenProps {
    viewData: IIngredientPurchaseViewState['view'],
    onViewClose(): void,
}
const IngredientPurchaseViewScreen: React.FC<IIngredientPurchaseViewScreenProps> = (props): ReactElement => {
...
export { IngredientPurchaseViewScreen };
