...
interface ISalesOrderReturnViewScreenProps {
    viewData: ISalesOrderReturnViewState['view'],
    onViewClose(): void,
}
const SalesOrderReturnViewScreen: React.FC<ISalesOrderReturnViewScreenProps> = (props): ReactElement => {
...
export { SalesOrderReturnViewScreen };
