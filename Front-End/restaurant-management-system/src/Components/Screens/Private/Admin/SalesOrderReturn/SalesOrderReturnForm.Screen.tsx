...
interface ISalesOrderReturnFormScreenProps {
    formData: ISalesOrderReturnViewState['form'],

    onFormStateChange(state: { [k in keyof (ISalesOrderReturnViewState)['form']]?: (ISalesOrderReturnViewState)['form'][k] }, callback?: undefined | (() => void)): void,
...
const SalesOrderReturnFormScreen: React.FC<ISalesOrderReturnFormScreenProps> = (props): ReactElement => {
    return (
        <Fragment>
            <Dialog
                isShown={props.formData.open}
                title="Sales Order Return Entry"
                confirmLabel="Save"
                intent={"success"}
                    ...
                    <Grid item sm={3}>
                        <div className={css`input {background: #fff2c3; font-weight: bold; font-size: 20px;`}>
                            <TextInputField
                                ...
                                value={convertToNumber(props.formData.payable_amount)}
                            />
                        </div>
                    </Grid>
                            ...
                            <Grid item sm={2}>
                                <div className={css`input {background: #f8c8c8; font-weight: bold;`}>
                                    <TextInputField
                                        ...
                                        value={convertToNumber(props.formData.due_amount)}
                                    />
                                </div>
                            </Grid>
                        </React.Fragment>
...
export { SalesOrderReturnFormScreen };
