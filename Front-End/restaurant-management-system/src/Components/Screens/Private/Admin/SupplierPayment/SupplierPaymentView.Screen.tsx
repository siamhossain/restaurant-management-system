...
interface ISupplierPaymentViewScreenProps {
    viewData: ISupplierPaymentViewState['view'],

    onViewClose(): void,
}
const SupplierPaymentViewScreen: React.FC<ISupplierPaymentViewScreenProps> = (props): ReactElement => {
    return (
        <Fragment>
            <Dialog
...
export { SupplierPaymentViewScreen };
