...
import {ProductDropdownScreen} from "@/Components/Screens/Private/Admin/Product/ProductDropdown.Screen";
import {IPurchaseOrderViewState} from "@/Views/Private/Admin/PurchaseOrder/PurchaseOrder.View";


interface IPurchaseOrderFormScreenProps {
    formData: IPurchaseOrderViewState['form'],

    onFormStateChange(state: { [k in keyof (IPurchaseOrderViewState)['form']]?: (IPurchaseOrderViewState)['form'][k] }, callback?: undefined | (() => void)): void,
...
const PurchaseOrderFormScreen: React.FC<IPurchaseOrderFormScreenProps> = (props): ReactElement => {
                ...
                <Grid container spacing={1}>
                    ...
                    <Grid item sm={3}>
                        <div className={css`input {background: #f8c8c8; font-weight: bold;`}>
                            <TextInputField
                                label="Total Amount"
                                value={props.formData.total_amount.toFixed(2)}
                                disabled={true}
                            />
                        </div>
                    </Grid>
...
export { PurchaseOrderFormScreen };
