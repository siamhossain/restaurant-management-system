...
import {DashboardBannerScreen} from "@/Components/Screens/Private/Admin/DashboardBanner";
import {TopProductsScreen} from "@/Components/Screens/Private/Admin/TopProducts";


const MainContainerScreen = (): ReactElement => {
    return (
        <Fragment>
            <div className={MainContainerStyleSheet.classes.root}>
                <div className="main-container">
                    <div className="small-header anim">Dashboard</div>
                        <DashboardBannerScreen/>
                    <div className="small-header anim">Top Products</div>
                    <TopProductsScreen/>
