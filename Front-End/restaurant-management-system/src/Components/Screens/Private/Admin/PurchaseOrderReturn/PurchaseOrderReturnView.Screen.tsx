...
interface IPurchaseOrderReturnViewScreenProps {
    viewData: IPurchaseOrderReturnViewState['view'],
    onViewClose(): void,
}
const PurchaseOrderReturnViewScreen: React.FC<IPurchaseOrderReturnViewScreenProps> = (props): ReactElement => {
...
export { PurchaseOrderReturnViewScreen };
