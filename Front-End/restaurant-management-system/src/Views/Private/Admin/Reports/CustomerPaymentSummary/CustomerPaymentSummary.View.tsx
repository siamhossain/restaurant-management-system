...
import {CustomerDropdownScreen} from "@/Components/Screens/Private/Admin/Customer/CustomerDropdown.Screen";
import {Button, Select} from "evergreen-ui";
import {ApiConfig} from "@/App/Config/Api";
import View from "@/Components/Base/View";

class CustomerPaymentSummaryView extends View<any, any> {
                ...
                <MainLayout>
                    ...
                    <div className="wrapper" style={{display: "flex", flexDirection: "column", flexGrow: 1}}>
                        ...
                        <div className={"main-container"} style={{paddingTop: '10px'}}>
                            <ModuleTitleScreen
                                moduleTitle={"Customer Payment Summary"}
                            />
                            <Grid container spacing={2} style={{marginLeft: "25px"}}>
                                ...
                                <Grid item lg={2}>
                                    <div style={{color: "#101840", fontSize: 14, fontWeight: 500, marginBottom: 5}}>Select Customer</div>
                                ...
                                <Grid item lg={3}>
                                    <div style={{color: "#101840", fontSize: 14, fontWeight: 500, marginTop: 5}}>
                                        <Button onClick={() => window.open(ApiConfig.REPORTS_ROOT + "/customer-payment-summary?from_date=" + this.state.form.from_date + "&to_date=" + this.state.form.to_date + "&user_uuid=" + this.state.form.user_uuid + "&customer_uuid=" + this.state.form.customer_uuid)} marginLeft={16} marginTop={20} appearance="primary" intent="success">
                                            Submit
                                        </Button>
                                    </div>
                                </Grid>
