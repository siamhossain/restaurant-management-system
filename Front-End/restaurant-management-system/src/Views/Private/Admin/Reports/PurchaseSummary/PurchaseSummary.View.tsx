...
class PurchaseSummaryView extends View<any, any> {
                                ...
                                <Grid container spacing={2} style={{marginLeft: "25px"}}>
                                    ...
                                    <Grid item lg={3}>
                                        <div style={{color: "#101840", fontSize: 14, fontWeight: 500, marginTop: 5}}>
                                            <Button
                                                onClick={() => window.open(ApiConfig.REPORTS_ROOT + "/purchase-summary?from_date=" + this.state.form.from_date + "&to_date=" + this.state.form.to_date + "&user_uuid=" + this.state.form.user_uuid + "&supplier_uuid=" + this.state.form.supplier_uuid)}
