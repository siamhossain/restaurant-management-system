...
import {SalesOrderProvider, SalesOrderReturnProvider} from "@/App/Services/Providers/Modules/Admin";



class SalesReturnDetailsView extends View<any, any> {
    ...
    private getAllOrderList() {
        SalesOrderReturnProvider.getSalesOrderReturnsNoLimit('', (data) => {
            this.setGridState({sales_order_return_list: data});
        })
    }
                ...
                <MainLayout>
                    ...
                    <div className="wrapper" style={{display: "flex", flexDirection: "column", flexGrow: 1}}>
                        ...
                        <div className={"main-container"} style={{paddingTop: '10px'}}>
                            <ModuleTitleScreen
                                moduleTitle={"Sales Return Details"}
                            />
                            <Grid container spacing={2} style={{marginLeft: "25px"}}>
                                <Grid item lg={3}>
                                    ...
                                    >
                                        ...
                                        {this.state.grid.sales_order_return_list.map((item: any, index: number) => (
                                ...
                                <Grid item lg={3}>
                                    <div style={{color: "#101840", fontSize: 14, fontWeight: 500, marginTop: 5}}>
                                        <Button onClick={() => window.open(ApiConfig.REPORTS_ROOT + "/sales-return-details?uuid=" + this.state.form.sales_uuid)} marginLeft={16} marginTop={20} appearance="primary" intent="success">
                                            Submit
                                        </Button>
                                    </div>
