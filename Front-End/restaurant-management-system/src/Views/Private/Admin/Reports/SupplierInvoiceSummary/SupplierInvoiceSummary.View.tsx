...
class SupplierInvoiceSummaryView extends View<any, any> {
                ...
                <MainLayout>
                    ...
                    <div className="wrapper" style={{display: "flex", flexDirection: "column", flexGrow: 1}}>
                        ...
                        <div className={"main-container"} style={{paddingTop: '10px'}}>
                            <ModuleTitleScreen
                                moduleTitle={"Supplier Invoice Summary"}
                            />
                            <Grid container spacing={2} style={{marginLeft: "25px"}}>
                                ...
                                <Grid item lg={3}>
                                    <div style={{color: "#101840", fontSize: 14, fontWeight: 500, marginTop: 5}}>
                                        <Button onClick={() => window.open(ApiConfig.REPORTS_ROOT + "/invoice-summary?from_date=" + this.state.form.from_date + "&to_date=" + this.state.form.to_date + "&user_uuid=" + this.state.form.user_uuid + "&uuid=" + this.state.form.supplier_uuid + "&type=" + "Supplier")} marginLeft={16} marginTop={20} appearance="primary" intent="success">
                                            Submit
                                        </Button>
                                    </div>
...
export default SupplierInvoiceSummaryView;
