...
import {PurchaseOrderProvider} from "@/App/Services/Providers/Modules/Admin";
import View from "@/Components/Base/View";

class PurchaseDetailsView extends View<any, any> {
    ...
    private getAllOrderList() {
        PurchaseOrderProvider.getProductPurchasesNoLimit('', (data) => {
                            ...
                            <Grid container spacing={2} style={{marginLeft: "25px"}}>
                                ...
                                <Grid item lg={3}>
                                    <div style={{color: "#101840", fontSize: 14, fontWeight: 500, marginTop: 5}}>
                                        <Button onClick={() => window.open(ApiConfig.REPORTS_ROOT + "/purchase-details?uuid=" + this.state.form.purchase_uuid)} marginLeft={16} marginTop={20} appearance="primary" intent="success">
                                            Submit
                                        </Button>
                                    </div>
