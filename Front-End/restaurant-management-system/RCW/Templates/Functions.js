...
export const ${stylesheetName}StyleSheet = {
    classes: {
        root: css\`
            /**
...
import { actionTypes } from "${onCustomDir ? ('@App/Root' + customTargetPath) : '@/App/WaterTank/Actions'}/${RemoveStartingSlash(actionFilePath)}";
...
import { I${fileName}StoreState, ${fileName}Store } from "${onCustomDir ? ('@App/Root' + customTargetPath) : '@/App/WaterTank/Stores'}/${RemoveStartingSlash(filePath)}";
