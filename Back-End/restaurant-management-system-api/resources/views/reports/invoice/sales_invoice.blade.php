                ...
                <table style="width:100%">
                    ...
                    <tr class="">
                        ...
                        @if(@$sales_order->payment_type === 'Cash')
                            <td><h2 style="text-align:right">{{number_format(@$sales_order->received_amount,2)}}</h2></td>
                        @else
                    ...
                    <tr class="border_bottom">
                        ...
                        @if(@$sales_order->paid_amount > 0)
                            <td><h2 style="text-align:right">{{number_format(@$sales_order->paid_amount)}}</h2></td>
                        @else
                            <td><h2 style="text-align:right">{{number_format(@$sales_order->payment_amount)}}</h2></td>
                        @endif
