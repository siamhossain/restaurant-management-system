...
class CreatePurchaseOrderReturnParticularsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchase_order_return_particulars', function (Blueprint $table) {
            $table->id();
            $table->uuid('uuid')->unique()->default(DB::raw('uuid()'));
            $table->uuid('product_purchase_return_uuid');
    ...
    {
        Schema::dropIfExists('purchase_order_return_particulars');
    }
}
