...
class CreateSalesOrderParticularsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sales_order_particulars', function (Blueprint $table) {
            $table->id();
            $table->uuid('uuid')->unique()->default(DB::raw('uuid()'));
            $table->uuid('sales_order_uuid');
            ...
            $table->enum('status', ['Pending', 'Inprogress', 'Ready', 'Served'])->default('Inprogress');
    ...
    {
        Schema::dropIfExists('sales_order_particulars');
    }
}
